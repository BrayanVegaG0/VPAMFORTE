  ...
  Future<List<SurveyModel>> getSurveys() async {
    ...
    final survey = SurveyModel(
      ...
      questions: [
        ...
        //SE DEBE MOSTRAR EL BARTHEL
        //SECCIÓN BAREMO
        QuestionModel(
          id: 'idConfinadoCamaD',
          title: 'Confinado  en cama',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
            QuestionOption(id: '1', label: 'Sí'),
            QuestionOption(id: '0', label: 'No'),
          ],
        ...
        QuestionModel(
          id: 'idConfinadoSillaRuedasD',
          title: 'Confinado  en  silla de ruedas',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idUsuarioSillaRuedasD',
          title: 'Usuario de silla de ruedas',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idAndaNoPonersePieD',
          title: 'Anda, pero no puede ponerse de pie o sentarse sin ayuda',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idAndaNecesitaGuiaD',
          title: 'Anda, pero necesitan que le guíen o ayuda de otra persona',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          ...
          section: SurveySection.baremo,
          options: [
            QuestionOption(id: '1', label: 'Puede'),
            QuestionOption(id: '0', label: 'No Puede'),
          ],
        ),
        QuestionModel(
          id: 'idLevantarseD',
        ...
        QuestionModel(
          id: 'idCambiosPostularesD',
          title: 'Cambios postulares',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idRopaCamaD',
          title: 'Manejo  de ropa en la cama',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idPrendasSuperiorCuerpoD',
          title: 'Ponerse/quitarse prendas de la mitad superior del cuerpo',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idPrendasInferiorCuerpoD',
          title: 'Ponerse/quitarse prendas de la mitad inferior del cuerpo',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idPrendasCalzadoD',
          title: 'Ponerse/quitarse calzado (zapatos, medias, calcetines)',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idAbrotarBotonesCremallerasD',
          title: 'Abrochar botones y corchetes, correr cremalleras',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idLavarseManosPeinarseD',
          title: 'Lavarse las manos, cara, peinarse, etc.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idLavarsePiesHigMenstrualD',
          title: 'Lavarse los pies, higiene menstrual, etc.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idOtrasActHigienePersonalD',
          title: 'Otras actividades de higiene personal (afeitarse,  cortarse las uñas, lavado del pelo, etc.)',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idSujetarCubiertosD',
          title: 'Sujetar y manejar cubiertos y otros utensilios',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idSujetarJarrasD',
          title: 'Sujetar   y manejar  jarras y vasos ',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idServirseCortarCarneD',
          title: 'Servirse, cortar carne, untar mantequilla, etc.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idAyudaUrgD',
          title: 'Obtener ayuda en una urgencia',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idLlamadasPuertaD',
          title: 'Contestar llamadas a la puerta',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idSeguridadAccesoD',
          title: 'Seguridad y acceso (manejar pestillos, llaves, cerrojos, abrir y cerrar puertas y ventanas',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idUsoDispositivosDomesticosD',
          title: 'Manejar dispositivos domésticos (grifos, enchufes, interruptores)',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idUsoRadiosLibrosD',
          title: 'Manejar objetos tales como radios, libros periódicos, etc.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idAparatosEspecialesD',
          title: 'Depende de aparatos especiales que requiere la ayuda de otras personas para su utilización, dializador, oxígenos,  alimentación por sonda, etc.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idPrecaucionesEspecialesD',
          title: 'Necesita de precauciones especiales ( por ejemplo en caso de tendencia a hemorragias, crisis epilépticas frecuentes o pérdidas de conciencia, etc.)',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idDependenciaPersonaD',
          title: 'Dependencia de otra persona para colocación de prótesis, órtesis, etc.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idIncapacidadTotalD',
          title: 'Incapacidad total o grave dificultad para mantener relaciones interpersonales incluso con los más próximos.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idConductasAgresivasD',
          title: 'Presenta hábitos inaceptables socialmente o conductas agresivas.- Tiene dificultades para mantener relaciones con amigos, vecinos o compañeros.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idConductasInadaptadasD',
          title: 'Presenta conductas inadaptadas, molestas o irritantes. Solo se relaciona con amigos, vecinos o compañeros.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idProteccionAbsolutaD',
          title: 'Necesita Protección  absoluta y un cuidado constante para no sufrir daños debido a su incapacidad de eludir riesgos.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idDisponibilidadContinuaD',
          title: 'Precisa una disponibilidad continua y una supervisión intermitente en ambientes controlados.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idNormasHabitualesConvivenciaD',
          title: 'Total incapacidad o grave dificultad intelectual para conocer, asumir o cumplir las normas habituales de convivencia y los usos y costumbres corrientes en su entorno.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idConocimientoNormasD',
          title: 'Presenta un grado limitado en el conocimiento de las normas y  usos, pero no es responsable,  ni se vale por si mismo.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idNormasEspecialesD',
          title: 'Capacidad de adaptarse a normas especiales, adecuadas a situaciones y ambientes de carácter restringido.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idRutinaCotidianaD',
          title: 'Incapacidad total o grave dificultad intelectual para organizar la rutina cotidiana y hacer frente a  situaciones o problemas habituales.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        QuestionModel(
          id: 'idProblemasHabitualesD',
          title: 'Incapacidad parar hacer frente a situaciones o problemas no habituales.',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.baremo,
          options: [
        ...
        //INFORMACION DE LA PERSONA CUIDADORA
        QuestionModel(
          id: 'idPersonaCuidadoraD',
          title: '¿La persona con discapacidad cuenta con una persona cuidadora? Ubicar el numero de cédula',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
            QuestionOption(id: '1', label: 'Sí'),
            QuestionOption(id: '0', label: 'No'),
          ],
        ...
        QuestionModel(
          id: 'idCuidadoOtrasPersonasD',
          title: '¿La persona cuidador/a realiza el  cuidado de otras personas adicional a la persona con discapacidad?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idCuidadoraDiscD',
          title: '¿La  persona cuidadora/or tiene discapacidad ?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idMiembroHogarSustitutoD',
          title: '¿Alguno de los miembros del hogar está certificado como sustituto de la persona con discapacidad?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idSustitutoTrabajaD',
          title: '¿Actualmente la persona sustituta trabaja?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idDiscCuidaPersonasHogarD',
          title: 'La persona con discapacidad cuida a otra/s persona/as de la familia, cubriendo el rol del cuidador principal?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idAyudaFamiliaD',
          title: '¿Piensa que su familiar le pide más ayuda de la que realmente necesita?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
            QuestionOption(id: '0', label: 'Nunca'),
            QuestionOption(id: '1', label: 'Casi Nunca'),
            QuestionOption(id: '2', label: 'A veces'),
            QuestionOption(id: '3', label: 'Bastantes veces'),
            QuestionOption(id: '4', label: 'Casi Siempre'),
          ],
        ),
        QuestionModel(
          id: 'idSuficienteTiempoD',
          title: '¿Piensa que debido al tiempo que dedica a su familiar no tiene suficiente tiempo para Ud.?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idAgobiadoCompatibilizarD',
          title: '¿Se siente agobiado por intentar compatibilizar el cuidado de su familiar con otras responsabilidades (trabajo, familia)?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idVerguenzaConductaFamD',
          title: '¿Siente vergüenza por la conducta de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idEnfadadoCercaFamD',
          title: '¿Se siente enfadado cuando está cerca de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idCuidarFamAfectaNegD',
          title: '¿Piensa que el cuidar de su familiar afecta negativamente la relación que usted tiene con otros miembros de su familia?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idMiedoFuturoFamD',
          title: '¿Tiene miedo por el futuro de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idFamDependeUstedD',
          title: '¿Piensa que su familiar depende de Ud.?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idTensoCercaFamD',
          title: '¿Se siente tenso cuando está cerca de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idSaludEmpeoradoD',
          title: '¿Piensa que su salud ha empeorado debido a tener que cuidar de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idMpTieneIntimidadD',
          title: '¿Piensa que no tiene tanta intimidad como le gustaría debido al cuidado de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idVidaSocialAfectadaD',
          title: '¿Piensa que su vida social se ha visto afectada de manera negativa por tener que cuidar a su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idIncomodoDistanciarseD',
          title: '¿Se siente incómodo por distanciarse de sus amistades debido al cuidado de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idFamiliarUnicaPersCuidarD',
          title: '¿Piensa que su familiar le considera a usted la única persona que le puede cuidar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idNoTieneSuficientesIngreD',
          title: '¿Piensa que no tiene suficientes ingresos económicos para los gastos de cuidar a su familiar, además de sus otros gastos?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idNoCapazCuidarFamD',
          title: '¿Piensa que no será capaz de cuidar a su familiar por mucho más tiempo?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idPerdidoControlD',
          title: '¿Siente que ha perdido el control de su vida desde que comenzó la enfermedad de su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idDejarCuidadoFamiliarD',
          title: '¿Desearía poder dejar el cuidado de su familiar a otra persona?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idIndecisoD',
          title: '¿Se siente indeciso sobre qué hacer con su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idDeberiaHacerMasFamD',
          title: '¿Piensa que debería hacer más por su familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
        ...
        QuestionModel(
          id: 'idGradoCargaExperimentaD',
          title: 'Globalmente, ¿qué grado de "carga" experimenta por el hecho de cuidar a tu familiar?',
          type: QuestionType.singleChoice,
          required: false,
          section: SurveySection.cargaCuidador,
          options: [
